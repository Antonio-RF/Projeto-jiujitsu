    ...
    <div className="page fade-in">
        ...
        <div className="sobre-layout">
          ...
          <div className="sobre-content">
            ...
            <ul className="sobre-list">
              ...
              <li><span className="sobre-bullet">✓</span> <b>Para quem?</b> estudantes, servidores, comunidade externa, iniciantes ou experientes!</li>
              <li><span className="sobre-bullet">✓</span> <b>Coordenação:</b> Prof. Tácito Pessoa de Souza Junior (Depto. de Educação Física/UFPR)</li>
            </ul>
        ...
        <div className="horarios-cards">
          <div className="horarios-card card-escolinha">
            ...
            <ul>
              ...
              <li><b>Horário:</b> <span className="horarios-hora">12h às 13h15</span></li>
              <li><b>Público:</b> <span className="horarios-publico">Só para iniciantes</span></li>
            </ul>
            <p className="horarios-desc">
              <span className="horarios-highlight">Ideal para quem nunca treinou ou está começando.</span>{" "}
              Foco em fundamentos, técnica básica, ambientação ao esporte.<br />
              <em>Após três meses, pode migrar para os treinos de competição.</em>
            </p>
          </div>
          <div className="horarios-card card-competicao">
            ...
            <ul>
              ...
              <li><b>Horário:</b> <span className="horarios-hora">18h30 às 20h30</span></li>
              <li><b>Público:</b> <span className="horarios-publico">Já pratica Jiu-Jitsu ou concluiu a Escolinha</span></li>
            </ul>
            <p className="horarios-desc">
              <span className="horarios-highlight">Para quem deseja competir ou se desafiar mais!</span>{" "}
              Técnicas avançadas, condicionamento, sparring, preparação para campeonatos e evolução pessoal.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="info home-mapa mapa-simples">
        ...
        <address className="mapa-endereco-clean">
          R. Coração de Maria, 92<br />
          Jardim Botânico, Curitiba - PR<br />
          <span className="mapa-ufpr-txt">Dentro da UFPR – Campus Botânico</span>
        </address>
